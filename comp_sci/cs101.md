...
It is possible to fit curves that have terrible predictive value. This is an issue that cannot be answered by statistics. One has to return to what the theoretical proposition states.
