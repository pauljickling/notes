...
## Functions/Machine Interpretations of a Programming
...
- When writing tests it is helpful to have statements evaluating what you think should happen (i.e. `"Should print True", bool`)
