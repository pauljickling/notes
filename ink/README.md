...
Variables are declared with the `VAR` keyword. Valid types are strings, integers, booleans, and diverts. Lists are also a data type, but are covered in a later section.
